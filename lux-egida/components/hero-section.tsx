...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden bg-white pt-20">
      <div className="absolute -right-64 -top-64 h-[500px] w-[500px] rounded-full bg-primary-50 blur-3xl opacity-50"></div>
      <div className="absolute -bottom-32 -left-32 h-[300px] w-[300px] rounded-full bg-secondary-50 blur-3xl opacity-50"></div>

      <div className="container relative px-4 py-24 md:px-6">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="mx-auto max-w-3xl text-center lg:text-left">
            <div className="mb-4 inline-block rounded-full bg-primary-50 px-4 py-1 text-sm font-medium text-primary">
            ...
            <p className="mb-12 text-lg leading-relaxed text-gray-600 md:text-xl">
              Lux Egida Advisors provides sophisticated wealth management and protection strategies for discerning

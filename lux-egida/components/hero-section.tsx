...
export function HeroSection() {
  return (
      <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden bg-slate-100 pt-20 animate-fade-in-slide">
        {/* Floating background blobs */}
        <div className="absolute -right-64 -top-64 h-[500px] w-[500px] rounded-full bg-primary-50 blur-3xl opacity-50 animate-float"></div>
        <div className="absolute -bottom-32 -left-32 h-[300px] w-[300px] rounded-full bg-secondary-50 blur-3xl opacity-50 animate-float delay-1000"></div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="mx-auto max-w-3xl text-center lg:text-left">
              ...
              <p className="mb-12 text-lg leading-relaxed text-gray-600 md:text-xl animate-fade-up animate-once animate-duration-700 animate-delay-300 animate-ease-in-out">
                Discreet, experienced, and fully aligned with your interests —
                across yachting, aviation, and real estate.
              </p>
              <div className="flex flex-col justify-center gap-4 sm:flex-row lg:justify-start animate-fade-up animate-once animate-duration-700 animate-delay-400 animate-ease-in-out">
                ...
                <span className="relative">
                  Our Philosophy
                  <span className="absolute -bottom-1 left-0 h-[1px] w-0 bg-primary opacity-0 transition-all duration-300 group-hover:w-full group-hover:opacity-100"></span>
                </span>
                </a>
                <a
                    href="#contact"

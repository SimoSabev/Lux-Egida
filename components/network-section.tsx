        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto max-w-3xl">
            <div className="text-center">
              <h2
                  className={`mb-4 font-serif text-3xl font-light text-primary sm:text-4xl transition-opacity duration-700 ${
                      isInView
              ...
              <div
                  className={`mx-auto mb-8 h-1 w-24 bg-secondary transition-opacity duration-700 ${
                      isInView
            ...
            <div
                className={`flex flex-col justify-center items-center rounded-xl bg-slate-200 p-8 shadow-2xl border border-gray-100 transition-opacity duration-700 ${
                    isInView
